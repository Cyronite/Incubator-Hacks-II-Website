        ...
        <div className="p-[5%] flex justify-between max-w-[1600px] mx-auto w-full max-lg:flex-col-reverse">
            <div id="Left" className=" mt-10 lg:mt-52">
                <div id="top">
                    ...
                    <div className="inter text-[#333333] text-2xl mb-[20px] max-w-[650px] max-lg:text-center max-lg:w-full max-lg:mx-auto">A beginner-focused hackathon hosted in Kitchener-Waterloo on October 4-5, 2025. Day 1 (October 4) will be held in-person at Greenhouse in Kitchener-Waterloo, while Day 2 (October 5) will be online. It's a space for high school students to explore new technologies, team up, and create meaningful projects over the weekend.</div>
